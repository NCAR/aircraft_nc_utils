...
subdirs = ['asc2cdf', 'asc2cdf_HRT', 'flt_area', 'flt_time', 'mkcdf', 'nc2iwg1', 'ncav', 'nc_compare', 'nc_dips', 'ncextr', 'ncfillvar', 'nc_gap', 'ncmerge', 'ncReorder', 'nc_sane', 'ncstat', 'ncvarlist', 'nc2asc/deploy']
